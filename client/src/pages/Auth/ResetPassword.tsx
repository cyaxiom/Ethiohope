...
import { Lock, Loader2, ArrowRight, Save, Home } from 'lucide-react';
...
const ResetPassword: React.FC = () => {
  ...
  if (!token) {
    return (
      <div className="public-shell min-h-screen flex items-center justify-center p-4 bg-[#070b16] relative text-slate-100">
        <Link 
          to="/" 
