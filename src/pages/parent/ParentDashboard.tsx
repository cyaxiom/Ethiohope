...
import { Heart, MessageSquare, Bell, TrendingUp, Calendar, ChevronRight, User } from 'lucide-react';
...
export const ParentDashboard: React.FC = () => {
  const children = [
    { name: 'Sarah Wilson', grade: 'Grade 10', attendance: 98, progress: 85, lastResult: 'A-' },
    { name: 'Alex Wilson', grade: 'Grade 8', attendance: 95, progress: 72, lastResult: 'B+' },
  ];
  ...
  return (
    <div className="animate-fadeIn pb-8 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        <StatCard title="Total Children" value="02" icon={Heart} color="red" />
        <StatCard title="Unread Messages" value="05" icon={MessageSquare} color="blue" trend={{ value: 2, isUp: true }} />
        <StatCard title="Notifications" value="12" icon={Bell} color="orange" />
      </div>

      {/* Main Content Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Child Progress Section */}
        <SectionCard title="Children Progress" className="h-full">
            ...
            {children.map((child, idx) => (
              <div key={idx} className="p-5 rounded-3xl bg-blue-50/30 border border-blue-50 hover:border-blue-100 hover:bg-blue-50 transition-all group">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button className="p-2 bg-white rounded-xl shadow-sm text-blue-500 hover:text-white hover:bg-blue-500 transition-all">
        ...
        <SectionCard title="Recent Messages" viewAllPath="/parent/messages">
          ...
          <div className="mt-8 p-6 rounded-3xl bg-gradient-to-tr from-blue-500 to-blue-600 text-white relative overflow-hidden group shadow-lg shadow-blue-100">
             <div className="z-10 relative">
               ...
               <p className="text-xs text-blue-50 font-medium mb-4 opacity-90 leading-relaxed italic">Check out the upcoming school activities and important dates for Sarah and Alex.</p>
