...
export default function LearningMaterials() {
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      {/* Decorative Blobs */}
      <div
        className={`absolute top-0 right-0 w-[200px] h-[200px] rounded-full blur-3xl opacity-50 -z-10 ${isDark ? "bg-purple-800" : "bg-purple-100"
          }`}
      />
      <div
        className={`absolute bottom-0 left-0 w-[180px] h-[180px] rounded-full blur-3xl opacity-50 -z-10 ${isDark ? "bg-yellow-800" : "bg-yellow-100"
          }`}
      />
