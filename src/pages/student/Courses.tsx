      ...
      {isLoading ? (
        ...
        <div className="bg-white border border-gray-100 p-16 rounded-[2.5rem] text-center shadow-sm">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            {search ? `We couldn't find any courses matching "${search}".` : "You haven't been registered for any courses yet."}
          </p>
          {!search && (
            <button className="mt-8 px-8 py-3 bg-blue-600 text-white font-black rounded-2xl shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all active:scale-95">
