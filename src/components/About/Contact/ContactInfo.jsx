...
const ContactInfo = () => {
   return (
      <section className="bg-[#0B0B29] pt-2 text-white flex flex-col max-[1024px]:px-20 max-[600px]:px-0 ">
         {/*  */}
    
         <div className="flex flex-col md:flex-row md:flex-wrap gap-5 w-full items-center px-6 justify-center">
            {/* Phone Number Section */}
            <div className="bg-gradient-to-br bg-[#1D1D3E] rounded-2xl px-12 py-8 pb-12 w-full md:w-[calc(50%-0.625rem)] custom-md:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.833rem)]">
               <div className="text-center md:text-left">
                  <div className="flex my-12 gap-4 items-center justify-center md:justify-start">
                     <div className="w-14 h-14 rounded-full bg-[#1D1D3E] border border-[#3e3d65] flex items-center justify-center">
                        <img src={phoneCall} alt="Phone Icon" />
                     </div>
                     <h3 className="text-xl font-bold">Phone Number</h3>
                  </div>
                  <div className="flex flex-col gap-2 items-center md:items-start">
                     <p className="text-2xl md:text-xl xl:text-3xl font-bold cursor-pointer hover:underline">+(555) 123-4567</p>
                     <p className="text-2xl md:text-xl xl:text-3xl font-bold cursor-pointer hover:underline">+(555) 987-6543</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-gradient-to-br bg-[#1D1D3E] rounded-2xl px-12 py-8 pb-12 w-full md:w-[calc(50%-0.625rem)] custom-md:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.833rem)]">
               <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-col gap-2 items-center md:items-start">
                     <p className="text-2xl md:text-xl xl:text-3xl font-bold  cursor-pointer hover:underline">coindox@gmail.com</p>
                     <p className="text-2xl  md:text-xl xl:text-3xl font-bold cursor-pointer hover:underline">info@gmail.com</p>
                  </div>
               </div>
            </div>

            {/* Location Section */}
            <div className="bg-gradient-to-br bg-[#1D1D3E] rounded-2xl px-12 py-8 pb-12 w-full md:w-[calc(50%-0.625rem)] custom-md:w-full lg:w-[calc(33.333%-0.833rem)] custom-md:max-w-[calc(50%-0.625rem)] custom-md:mx-auto">
               <div className="text-center md:text-left">
                  <div className="flex my-12 gap-4 items-center justify-center md:justify-start">
                     <div className="w-14 h-14 rounded-full bg-[#1D1D3E] border border-[#3e3d65] flex items-center justify-center">
                  ...
                  <div className="flex flex-col gap-2 items-center md:items-start">
                     <p className="text-2xl md:text-xl xl:text-3xl font-bold">123 Main Street</p>
                     <p className="text-2xl  md:text-xl xl:text-3xl font-bold">Anytown, CA 98765</p>
                  </div>
               </div>
            </div>
         </div>
